...
<head>
    ...
    <title>DBOrders! - Edit Product</title>
...
<body class="d-flex flex-column">
    ...
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col">
                <h1>Product <?=$product->getProductCode()?></h1>
            </div>
        </div>
        <?=(isset($_GET['error'])) ? '<div class="alert alert-danger mb-4" role="alert">Error while updating the product</div>' : ((isset($_GET['success'])) ? '<div class="alert alert-success mb-4" role="alert">Product updated successfully!</div>' : "");?>
        <form method="post" id="form-submit" action="products-api-update?id=<?=$product->getProductCode()?>">
            <div class="row mb-3">
                <div class="col">
                    <h4>Data:</h4>
                </div>
            ...
            <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10 col-md-4">
                    <input type="text" class="form-control" name="product-code" placeholder="S10_0000"
                        oninput='checkProductCode("<?=$product->getProductCode()?>")' id="product-code"
                ...
                <div class="col-sm-10 col-md-4">
                    <select class="form-control" name="product-line" placeholder="Product Line">
                        ...
                        <option value="<?=$row['productLine'];?>"
                            <?=(($row['productLine']==$product->getProductLine()?"selected":""))?>>
            ...
            <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="product-vendor" placeholder="John Smith's Diecast"
                        ...
                        value="<?=$product->getProductVendor()?>">
            ...
            <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10">
                    <textarea rows="10" class="form-control" name="product-description" placeholder="The product description. Insert information about materials and colors, as well as the product functions. Be concise but detailed."
                        ...
                        id="product-description"><?=$product->getProductDescription()?></textarea>
            ...
            <div class="form-group row align-items-center">
                ...
                <div class="col-sm-10 col-md-4">
                    <input type="number" min="0" step="1" class="form-control" name="quantity" placeholder="17"
                        oninput='checkDataLength("quantity","quantity-sm",1,65536)' id="quantity" value="<?=$product->getQuantityInStock()?>">
                ...
                <input type="number" min="0" step="0.1" class="form-control" name="price" placeholder="12,99"
                        oninput='checkDataLength("price","price-sm",1,65536)' id="price" value="<?=$product->getBuyPrice()?>">
            ...
            <div class="form-group row align-items-center">
                ...
                <input type="number" min="0" step="0.1" class="form-control" name="msrp" placeholder="27,99"
                        oninput='checkDataLength("msrp","msrp-sm",1,50)' id="msrp" value="<?=$product->getMsrp()?>">
